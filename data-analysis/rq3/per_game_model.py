...
def per_game_model(config_path):
    ...
    for game in games:
        ...
        X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=config_dict["test_size"], random_state=config_dict["random_state"])

        regr = RandomForestRegressor(n_estimators=config_dict["n_estimators"],
